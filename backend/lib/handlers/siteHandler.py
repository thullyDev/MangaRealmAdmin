        ...
        return {
            ...
            "values": {
                "images": {
                    ...
                    "alert": {"name": "alert", "value": "/gifs/alert.gif"},
                    "maintenance": {"name": "maintenance", "value": "/gifs/maintenance.gif"},
                    "empty": {"name": "empty", "value": "/gifs/empty.gif"},
                    "admin_background": {"name": "admin_background", "value": "/gifs/admin-login-background.gif"},
